      ...
      <div className="flex items-center gap-3 md:gap-5 pointer-events-auto">
        ...
        <div>
          ...
          <div className="flex items-center gap-2">
            ...
            <p className="text-[9px] md:text-[10px] text-indigo-300 uppercase tracking-[0.2em] md:tracking-[0.3em] font-bold">Neural Core v2.0</p>
          </div>
        </div>
      </div>

      <div className="hidden lg:flex items-center gap-4 pointer-events-auto bg-white/5 border border-white/10 backdrop-blur-xl px-4 py-2 rounded-2xl shadow-2xl transition-all hover:bg-white/10">
        <div className="flex flex-col items-end">
          <span className="text-[9px] text-white/40 uppercase tracking-widest font-bold">Protocolo Seguro</span>
          <span className="text-[11px] text-indigo-200 font-medium">Conexão Criptografada</span>
        </div>
      </div>
    </header>
  );
